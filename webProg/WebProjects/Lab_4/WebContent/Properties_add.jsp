...
<body>
	<%
		if (request.getParameter("pname") != null && request.getParameter("pvalue") != null && !request.getParameter("pname").trim().equals("") && !request.getParameter("pvalue").trim().equals("")){
			...
			FileOutputStream outputStream = new FileOutputStream("C:/Users/Vre2tos/Desktop/labexe4/WebContent/WEB-INF/example.properties");
	...
	<form method="get" action="Properties_add.jsp">
		<table>
			<tr>
				<td>Property Name:</td>
