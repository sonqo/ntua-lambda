...
with open('trans_turtle.owl', 'a') as owl_file:
    for index, row in agency.iterrows():
        i = 0
        for e in row:
            if i == 0:
                i += 1
                owl_file.write('\n:' + unidecode(str(e)) + ' rdf:type ' + 'Agency ;\n')
            elif i == 1:
                i += 1
...
with open('trans_turtle.owl', 'a') as owl_file:
    for index, row in route.iterrows():
        ...
        for e in row:
            if i == 0:
                i += 1
                owl_file.write(':' + unidecode(str(e)) + ' rdf:type ' + 'Route ;\n')
            elif i == 2:
                i += 1
...
with open('trans_turtle.owl', 'a') as owl_file:
    for index, row in stops.iterrows():
        ...
        for e in row:
            if i == 0:
                i += 1
                owl_file.write(':' + unidecode(str(e)) + ' rdf:type ' + 'Stop ;\n')
            elif i == 2:
                i += 1
...
with open('trans_turtle.owl', 'a') as owl_file:
    for index, row in trips.iterrows():
        i = 0
        owl_file.write(':' + unidecode(str(row[2])) + ' rdf:type ' + 'Trip ;\n')
        for e in row:
            if i == 0:
                i += 1
